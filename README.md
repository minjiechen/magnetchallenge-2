...
- We apologize in the delay of the transfer of the award money to the prize winners. Due to the recent administrative change in IEEE, we are still working with IEEE to finalize the fund transfer to Princeton University. We anticipate to finish this process and start distributing the prize money before the end of the summer. 
...
- [APEC Keynote Slides](docs/apeckeynote.pdf)
- [APEC Pictures](https://www.dropbox.com/scl/fo/4x6cevzcule6wkry9dky1/ADXsC7HIWNR-bwZgeotJDzQ?rlkey=jyb8lzfkdcmt96caodfzfymw5&dl=0)
...
## Reference Papers
- S. Wang et al., "Unified Time Domain Foundation Models for Hysteretic Passive Components," in IEEE 26th Workshop on Control and Modeling for Power Electronics (COMPEL), Knoxville, TN, USA, 2025, pp. 1-8, [Paper](https://ieeexplore.ieee.org/abstract/document/11121278)
